...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <nav class="bg-blue-600 text-white shadow-md">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <span class="self-center text-2xl font-semibold whitespace-nowrap">Dika Gantenk Bgt</span>
            </a>
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                @else
                    ...
                    <a href="/register" class="text-blue-600 bg-white hover:bg-gray-100 font-medium rounded-lg text-sm px-4 py-2">Register</a>
                @endauth
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-blue-500 rounded-lg bg-blue-700 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-blue-600">
                    <li>
                    ...
                    <li>
                        <a href="/posts" class="block py-2 px-3 text-white rounded hover:bg-blue-700 md:hover:bg-transparent md:hover:text-blue-200 md:p-0 {{ request()->is('posts*') ? 'text-yellow-300 font-bold' : '' }}">Blog</a>
                    </li>
                    <li>
    ...
    <footer class="bg-gray-800 text-white p-4 text-center mt-auto">
        &copy; 2025 Dika Gantenk Banget. All rights reserved.
    </footer>
